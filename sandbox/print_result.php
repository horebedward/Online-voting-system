        ...
        <div class="col-md-12">
            ...
            if(!isset($_GET['organization'])) {
                ...
                <div class="logo-title">
                    ...
                    <table>
                        <tr>
                            <td><img src="../assets/images/logo.jpg" style="width:80px;height:80px;"></td>
                            <td><br/>
                                <p style="text-align: left;">
                                    <b><strong>THE UNIVERSITY OF LAHORE</strong></b><br />
                                     DEFENCE ROAD CAMPUS 1KM RAIWIND ROAD<br />
                                    LAHORE,PAKISTAN
                                </p>
                            </td>
                        </tr>
...
<nav class="navbar navbar-inverse navbar-fixed-bottom" role="navigation">
    ...
    <div class="container">
        <div class="navbar-text pull-left">
            Copyright 2017 &copy; Horeb Edward & Ammar Liaqat (University Of Lahore)
        </div>
    </div>
